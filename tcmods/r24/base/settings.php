...
// TC (Tim Curtis) 2015-10-30: add Audiophonics PCM5122 DAC, PlainDAC+ and HifiBerry DAC+ Pro
...
// TC (Tim Curtis) 2015-10-30: autoplay after start
...
// TC (Tim Curtis) 2015-10-30: add Audiophonics PCM5122 DAC, Mamboberry HiFi DAC+, Lucid Labs Raspberry Pi DAC, PlainDAC, PlainDAC+ and HifiBerry DAC+ Pro 
...
if ($kernelver == '3.18.5+' || $kernelver == '3.18.11+' || $kernelver == '3.18.14+' || $kernelver == '4.1.10+') {
	...
	$_i2s['i2s'] .= "<option value=\"Mamboberry HiFi DAC+\" ".(($_SESSION['i2s'] == 'Mamboberry HiFi DAC+') ? "selected" : "").">Mamboberry HiFi DAC+</option>\n";
...
// TC (Tim Curtis) 2015-10-30: add 4.1.10 kernel to select list
