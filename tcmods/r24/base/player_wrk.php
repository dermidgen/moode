 ...
 *	- set currentsong.txt file permissions
 *
 */
...
// TC (Tim Curtis) 2014-11-30: set WEBRADIO file permissions
sysCmd('chmod 777 /var/lib/mpd/music/WEBRADIO/*.*');

// TC (Tim Curtis) 2015-07-31: set SDCARD dir permissions
sysCmd('chmod 777 /var/lib/mpd/music/SDCARD');

// TC (Tim Curtis) 2014-12-23
// - set tcmods.conf file permissions
sysCmd('chmod 777 /var/www/tcmods.conf');

// TC (Tim Curtis) 2015-05-30: set playhistory.log file permissions
sysCmd('chmod 777 /var/www/playhistory.log');

// TC (Tim Curtis) 2015-06-26: set liblog.txt file permissions
sysCmd('chmod 777 /var/www/liblog.txt');

// TC (Tim Curtis) 2015-10-30: set currentsong.txt file permissions
...
// TC (Tim Curtis) 2015-10-30: get release version instead of package version
...
// TC (Tim Curtis) 2015-10-30: set HifiBerry+ device analog volume controls to 0dB
...
// TC (Tim Curtis) 2015-10-30: auto play last played item
