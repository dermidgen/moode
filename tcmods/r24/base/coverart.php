...
/**
 * This file is used to provide cover art to Moode, MPoD and MPaD client apps
 *
 * the script looks for flac, mp3 or m4a embedded art, Folder, folder, Cover, cover png/jpg/jpeg files, or
 * any other image file.
 *
 * pass file to be checked in the following way:
 *
 *		/coverart.php/some/local/file/name
 *
 * make sure client is configured to hand cover requests to /coverart.php
 * or setup and nginx catch-all rule:
 *
 * 		try_files $uri $uri/ /coverart.php;
 *
 * 2015-10-30: Version 4
